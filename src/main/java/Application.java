...
public class Application {
    ...
    private static boolean isProgramInterrupted;
    ...
    private static void viewCommand(String[] input) {
    ...
    private static void executeCommand(Scanner scanner, String[] input) {
        Order order;
        try {
